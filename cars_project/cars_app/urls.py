...
urlpatterns = [    
    ...
    # API маршруты
    path('api/cars/', views.CarListCreateAPIView.as_view(), name='car-list'),
    ...
    path('api/cars/<int:pk>/comments/', views.CommentListCreateAPIView.as_view()),  # Для чтения, обновления и удаления
